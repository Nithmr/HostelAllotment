 ...
 *  */
   echo $this->Html->script('jquery.imageupload.js');
     echo $this->Html->script('validation.js');
...
<?php
    ...
    <p class="placename">
        <label for="bloodgroup"> Blood Group </label>
            ...
            <option value="<?php echo $user_bloodgroup ?>"><?php echo $user_bloodgroup ?></option><?php } ?>
	...
	<p style="color:red"> Note:- The Information provided by you should be correct, strict action will be taken if the information is found to be incorrect<br />
