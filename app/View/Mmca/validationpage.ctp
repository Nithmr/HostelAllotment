...
<form method="get" action="<?php echo $base_url ?>/mmca/validationpage" >
...
<div id="validationdiv">
    ...
    $('#pageno').pagination({
      pages :<?php echo $noofpages ?>,
        ...
        hrefTextPrefix:"<?php echo "$base_url/mmca/validationpage?vtype=$vtype&pageno=" ?>"
    });
});    
        ...
        <table border ="1" width="600px">
            ...
            if(!empty($valuserlist))
            {
               ...
               // pr($valuserlist);
                ...
                echo  "<td>$name</td>"; 
                echo "<td><a href='$base_url/mmca/viewinformation?pageno=$currentpage&vtype=$vtype&rollno=$rollno'>view more </a></td>";
