...
?>    
    ...
    <div id="userinfobottom">
            ...
            if(isset($vtype))
            {
                $url="$base_url/mmca/validation?vtype=$vtype&pageno=$page&rollno=$roll&";
                $urle="$base_url/mmca/filluserinfo?vtype=$vtype&pageno=$page&rollno=$roll";
                $urlb="$base_url/mmca/validationpage?vtype=$vtype&pageno=$page&rollno=$roll";
            }
            else if(isset($text))
            {
                $url="$base_url/mmca/validation?pageno=$page&search=search&textfield=$text&searchfield=$search&rollno=$roll&";
                $urle="$base_url/mmca/filluserinfo?pageno=$page&search=search&textfield=$text&searchfield=$search&rollno=$roll";
                $urlb="$base_url/mmca/search?pageno=$page&search=search&textfield=$text&searchfield=$search&rollno=$roll";
