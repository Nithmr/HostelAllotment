...
<div id="userinfoform">
    ...
    <?php 
      if(isset($vtype))
            {
                $urle="$base_url/mmca/filluserinfo?vtype=$vtype&pageno=$pageno&rollno=$roll__no";
            }
            else if(isset($text))
            {
                $urle="$base_url/mmca/filluserinfo?pageno=$pageno&search=search&textfield=$text&searchfield=$search&rollno=$roll__no";
            }
    ?>
